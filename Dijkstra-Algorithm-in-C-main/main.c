...
void insert_vertex(VtxData name){
    if(is_full_graph())
        error("Error: Da vuot qua so dinh do thi\n");
    else
        vdata[vsize++] = name;
}
...
void print_shortest_path(int start, int end){
    printf("[Duong ngan nhat: %c-----%c] %c", vdata[end], vdata[start], vdata[end]);
...
int main(){
    int i;
    load_wgraph("input.txt");
    printf("Thuat toan Dijkstra tim duong di ngan nhat U->V\n");
